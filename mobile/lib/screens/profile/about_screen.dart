      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Esnaf Takvim', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppTheme.textPrimary)),
            ...
            const Spacer(),
            Text('© 2026 Esnaf Takvim. Tüm hakları saklıdır.', style: TextStyle(color: Colors.grey[500], fontSize: 12)),
